...
const rows = [
  ...
  { feature: "Follower growth tracking (90-day history)", sge: true, them: false },
  ...
  { feature: "Free plan available", sge: true, them: true },
  ...
  { feature: "Engagement-first (not just scheduling)", sge: true, them: false },
];
    ...
    <PublicPageLayout>
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-12 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
          ...
          <span className="bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent">Buffer</span>
        </h1>
        <p className="text-lg text-white/60 max-w-2xl mx-auto mb-10">
          Buffer helps you schedule posts. Social Growth Engine helps you grow your audience. If follower growth is your goal, here is how the two platforms compare.
        </p>
      </section>
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-white/60 mb-8 max-w-lg mx-auto">Start growing your audience with AI — free, no credit card required.</p>
